...
public class CarController {
	...
	public ApiResponse getCarDescription (@PathVariable int carId) {
		return carService.getCarDescription(carId);
	}
	...
	public ApiResponse createCar (@RequestBody Car car, @PathVariable int carOwnerId) {
		return carService.createCar(car, carOwnerId);
	}
	...
	public ApiResponse stopRentalCar (@PathVariable int carId) {
		return carService.stopRentalCar(carId);
	}
}
